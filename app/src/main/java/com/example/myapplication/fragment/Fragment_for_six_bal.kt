...
class Fragment_for_six_bal : Fragment() {
    ...
    lateinit var binding: FragmentForSixBalBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentForSixBalBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun result(): String {
        ...
        binding.apply {
            ...
            return (((balOne * kreditOne) + (balTwo * kreditTwo) + (balThree * kreditThree) + (balFour * kreditFour) + (balFive*kreditFive) + (balSix*kreditSix)) / (kreditOne + kreditTwo + kreditThree + kreditFour + kreditFive + kreditSix)).toString()
        }
